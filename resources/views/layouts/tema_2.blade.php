...
<html class="no-js" lang="en">
    <head>
        ...
        ================================================== -->
        <meta charset="utf-8">
        <title>@yield("title","Once_2")</title>
        ...
        <!-- CSS
        ================================================== -->
        <link rel="stylesheet" href="{{asset("assets/tema_2/frontend/css/base.css")}}">
        <link rel="stylesheet" href="{{asset("assets/tema_2/frontend/css/vendor.css")}}">
        <link rel="stylesheet" href="{{asset("assets/tema_2/frontend/css/main.css")}}">
        <link rel="stylesheet" href="{{asset("assets/tema_2/frontend/css/login.css")}}">
        @stack("customCSS")
        ...
        <!-- favicons
        ================================================== -->
        <link rel="shortcut icon" href="{{asset("assets/tema_2/frontend/images/thumbs/icon.png")}}" type="image/x-icon">
        <link rel="icon" href="{{asset("assets/tema_2/frontend/images/thumbs/icon.png")}}" type="image/x-icon">
                    ...
                    <div class="block-1-2 block-m-full popular__posts">
                        <article class="col-block popular__post">
                            <a href="#0" class="popular__thumb">
                                <img src="{{asset("assets/tema_2/frontend/images/thumbs/small/tulips-150.jpg")}}" alt="">
                            </a>
                        ...
                        <article class="col-block popular__post">
                            <a href="#0" class="popular__thumb">
                                <img src="{{asset("assets/tema_2/frontend/images/thumbs/small/wheel-150.jpg")}}" alt="">
                            </a>
                        ...
                        <article class="col-block popular__post">
                            <a href="#0" class="popular__thumb">
                                <img src="{{asset("assets/tema_2/frontend/images/thumbs/small/shutterbug-150.jpg")}}" alt="">
                            </a>
                        ...
                        <article class="col-block popular__post">
                            <a href="#0" class="popular__thumb">
                                <img src="{{asset("assets/tema_2/frontend/images/thumbs/small/cookies-150.jpg")}}" alt="">
                            </a>
                        ...
                        <article class="col-block popular__post">
                            <a href="#0" class="popular__thumb">
                                <img src="{{asset("assets/tema_2/frontend/images/thumbs/small/beetle-150.jpg")}}" alt="">
                            </a>
                        ...
                        <article class="col-block popular__post">
                            <a href="#0" class="popular__thumb">
                                <img src="{{asset("assets/tema_2/frontend/images/thumbs/small/salad-150.jpg")}}" alt="">
                            </a>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved<i class="fa fa-heart" aria-hidden="true"> | Begenç HACİYEW | Berat CEYHAN</i>
    ...
    <div class="go-top">
        ...
        <script src="{{asset("assets/tema_2/frontend/js/plugins.js")}}"></script>
        <script src="{{asset("assets/tema_2/frontend/js/main.js")}}"></script>
        @stack("customJs")
    </body>
</html>