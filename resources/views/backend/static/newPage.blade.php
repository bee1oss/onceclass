    ...
    <div class="box box-info">
        ...
        <form class="form-horizontal">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="keywords" class="col-sm-2 control-label">Aanahtar Kelimeler</label>

                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="keywords" placeholder="Aanahtar Kelimeler"  value="@if(isset($page)) {{$page->keywords}} @endif"">
                    </div>
                </div>
                <div class="form-group">
            ...
            <div class="box-footer">
                <a href="{{route("backend.static.show")}}" type="button" class="btn btn-default" >İptal</a>
                <a type="button" class="btn btn-info pull-right" id="submitButton" href="{{route("backend.static.show")}}">Kaydet</a>
            </div>
            <!-- /.box-footer -->
        </form>
    </div>
