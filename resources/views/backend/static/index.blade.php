                            ...
                            <table class="table table-hover">
                                ...
                                @foreach($pages as $page)
                                    <tr>
                                        ...
                                        <td>{{$page->name}}</td>
                                        <td>{{$page->slug}}</td>
                                        <td><button class="btn btn-danger pageDelete" data-id="{{$page->id}}">Sil</button>
                                        <a href="{{route("backend.static.editPageShow",["slug"=>$page->slug])}}" class="btn btn-primary">Düzelnle</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </table>
