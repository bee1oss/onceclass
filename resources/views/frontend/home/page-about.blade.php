    ...
    <section class="s-content s-content--top-padding s-content--narrow">
        ...
        <div class="row">
            <div class="col-full s-content__main">
                <p>
                    <img src="{{asset("assets/frontend/images/thumbs/about/about-1000.jpg")}}"
                         srcset="{{asset("assets/frontend/images/thumbs/about/about-2000.jpg")}} 2000w,
                            {{asset("assets/frontend/images/thumbs/about/about-1000.jpg")}} 1000w,
                            {{asset("assets/frontend/images/thumbs/about/about-500.jpg")}} 500w"
