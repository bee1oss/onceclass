    ...
    <section class="s-content s-content--top-padding s-content--narrow">
        ...
        <article class="row entry format-video">
            ...
            <div class="col-full entry__main">
                ...
                <p>
                    <img src="{{asset("assets/tema_2/frontend/images/wheel-1000.jpg")}}" srcset="{{asset("assets/tema_2/frontend/images/wheel-2000.jpg")}} 2000w, {{asset("assets/tema_2/frontend/images/wheel-1000.jpg")}} 1000w, {{asset("assets/tema_2/frontend/images/wheel-500.jpg")}} 500w" sizes="(max-width: 2000px) 100vw, 2000px" alt="">
                </p>
